...
*EBayApi* | [**ebaySearchByImage**](docs/Api/EBayApi.md#ebaysearchbyimage) | **POST** /v1/ebay/search/by-image | Search by image
...
*VintedApi* | [**vintedSearchByImage**](docs/Api/VintedApi.md#vintedsearchbyimage) | **POST** /v1/vinted/search_by_image | Search by image
...
- [UserItemsResponse](docs/Model/UserItemsResponse.md)
...
- [VintedBrand](docs/Model/VintedBrand.md)
- [VintedColor](docs/Model/VintedColor.md)
- [VintedImageSearchRequest](docs/Model/VintedImageSearchRequest.md)
- [VintedItemDetail](docs/Model/VintedItemDetail.md)
- [VintedItemSummary](docs/Model/VintedItemSummary.md)
- [VintedMobileReadRequest](docs/Model/VintedMobileReadRequest.md)
- [VintedPagination](docs/Model/VintedPagination.md)
- [VintedPhoto](docs/Model/VintedPhoto.md)
- [VintedPrice](docs/Model/VintedPrice.md)
- [VintedSellerSummary](docs/Model/VintedSellerSummary.md)
- [VintedStatus](docs/Model/VintedStatus.md)
- [VintedUserProfile](docs/Model/VintedUserProfile.md)
- [VintedUserSummary](docs/Model/VintedUserSummary.md)
