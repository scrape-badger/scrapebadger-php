 ...
 *
 * @category Class
 * @description Envelope returned by search and search_by_image.
 * @package  ScrapeBadger
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
    ...
    */
    ...
    public function setSellerCountry($seller_country)
    {
        if (is_null($seller_country)) {
            array_push($this->openAPINullablesSetToNull, 'seller_country');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('seller_country', $nullablesSetToNull);
            if ($index !== FALSE) {
