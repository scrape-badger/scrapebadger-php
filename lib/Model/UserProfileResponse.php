 ...
 *
 * @category Class
 * @description Envelope returned by user profile.
 * @package  ScrapeBadger
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class UserProfileResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'user' => '\ScrapeBadger\Model\VintedUserProfile',
        'market' => 'string'
    ];
    ...
    */
     ...
     * Gets user
     *
     * @return \ScrapeBadger\Model\VintedUserProfile
     */
     ...
     * Sets user
     *
     * @param \ScrapeBadger\Model\VintedUserProfile $user user
     *
     * @return self
     */
