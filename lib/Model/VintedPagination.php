...
/**
 * VintedPagination Class Doc Comment
 *
 * @category Class
 ...
 */
class VintedPagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VintedPagination';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('total_entries', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($total_entries)) {
            throw new \InvalidArgumentException('non-nullable total_entries cannot be null');
        }
